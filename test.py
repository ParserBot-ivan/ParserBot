...
PROXY = 'socks5://userproxy:password@213.136.89.190:12494' 
...
def chech_currency(Money):
	...
	if Money + DIFF <= btc:
		...
		message_str = "Курс вырос на " + str(btc - Money) + '$'
		bot.send_message(764490361, message_str)
		message_str = "Сейчас его цена: " + str(btc)
		bot.send_message(764490361, message_str)
		Money = btc
	if Money - DIFF >= btc:
		print("Курс упал на ", Money - btc, '$')
		print("Сейчас его цена: ", btc)
		message_str = "Курс упал на " + str(Money - btc) + '$'
		bot.send_message(764490361, message_str)
		message_str = "Сейчас его цена: " + str(btc)
		bot.send_message(764490361, message_str)
		Money = btc
